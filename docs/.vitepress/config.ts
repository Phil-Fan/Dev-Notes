      ...
      "/Cloud/": [
        {
          ...
          items: [
            ...
            { text: "Cloudflare", link: "/Cloud/cloudflare" },
            ...
            { text: "K3s 部署方案", link: "/Cloud/k3s-plan" },
      ...
      "/Ops/": [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: false,
              items: [
                { text: "Arduino", link: "/Ops/hardware/Arduino" },
                { text: "DGX Spark", link: "/Ops/hardware/DGXSpark" },
                { text: "FPGA", link: "/Ops/hardware/FPGA" },
                { text: "Jetson Orin Nano", link: "/Ops/hardware/JetsonNano" },
                { text: "Jetson Thor", link: "/Ops/hardware/JetsonThor" },
                { text: "Raspberry Pi", link: "/Ops/hardware/RaspberryPi" },
              ],
            },
          ],
        },
      ...
      "/Tools/": [
        {
          ...
          items: [
            ...
            { text: "Adobe Illustrator", link: "/Tools/AdobeIllustrator" },
            { text: "Adobe Photoshop", link: "/Tools/AdobePhotoshop" },
            { text: "L2TP", link: "/Tools/l2tp" },
          ],
        },
      ],
      "/PM/": [
